-- סקריפט לבדיקת מצב ה-authentication והרשאות
-- הרץ את זה ב-Supabase SQL Editor

-- 1. בדוק אם יש בעיה עם הגדרות ה-RLS הכלליות
...
-- 3. בדוק אם יש בעיה עם הגדרות ה-RLS הכלליות
...
-- 4. בדוק אם יש בעיה עם הגדרות ה-RLS הכלליות
