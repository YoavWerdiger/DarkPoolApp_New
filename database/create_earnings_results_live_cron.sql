...
-- - אחרי צהריים: 15:30-17:00 שעון ישראל (אחרי סגירה)
-- - לילה: 22:30-00:00 שעון ישראל (אחרי סגירה)
...
-- הפונקציה עצמה בודקת אם זה בשעות דיווחים (8:00-10:00 או 16:00-20:00 שעון ישראל)
