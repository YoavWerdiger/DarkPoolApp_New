-- מחיקה ויצירה מחדש של פונקציות ריאקציות עם טיפוסים נכונים
...
-- יצירת פונקציה לקבלת ריאקציות להודעה - עם טיפוסים נכונים
...
-- יצירת פונקציה להוספה/הסרה של ריאקציה - עם טיפוסים נכונים
