...
/**
 * מזהה ציבורי ל־Brandfetch CDN (לוגואי טיקרים).
 * אפשר לעקוף ב־EXPO_PUBLIC_BRANDFETCH_CLIENT_ID — אותו מזהה כבר בשימוש ב־EarningsReportsTab.
 */
export const BRANDFETCH_CLIENT_ID =
  readProcessEnv('EXPO_PUBLIC_BRANDFETCH_CLIENT_ID') ?? '1idgv-PUKssFHXQBcKA';
