...
echo "🚀 בדיקת מערכת דיווחי התוצאות - אינדקסים גדולים"
echo "================================================"
...
echo ""
echo "📊 1. בדיקת Major Indices Earnings..."
...
echo "🎯 אמור לראות רק מניות מהאינדקסים הגדולים (S&P 500, NASDAQ, Dow Jones)"
echo "📅 רק דיווחים עתידיים (מהיום ואילך)"
